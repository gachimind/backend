...
const dataSource = new typeorm_1.DataSource({
    ...
    entities: [user_entity_1.User, token_map_entity_1.TokenMap, socketIdMap_entity_1.SocketIdMap, room_entity_1.Room, player_entity_1.Player, keyword_entities_1.Keyword, turn_entity_1.Turn, turnResult_entity_1.TurnResult, gameResult_entity_1.GameResult],
    synchronize: true,
    logging: true,
});
