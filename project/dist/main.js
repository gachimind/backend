...
function quickDT(obj, zone) {
  ...
  const tsNow = _settings_js__WEBPACK_IMPORTED_MODULE_7__["default"].now(),
...
class DateTime {
  ...
  static fromObject(obj) {
    ...
    const tsNow = _settings_js__WEBPACK_IMPORTED_MODULE_7__["default"].now(),
      ...
      loc = _impl_locale_js__WEBPACK_IMPORTED_MODULE_5__["default"].fromObject(obj);
  ...
  */
  ...
  diff(otherDateTime, unit = "milliseconds", opts = {}) {
    if (!this.isValid || !otherDateTime.isValid) {
      return _duration_js__WEBPACK_IMPORTED_MODULE_3__["default"].invalid(
...
function gregorianToWeek(gregObj) {
  ...
  return Object.assign({ weekYear, weekNumber, weekday }, (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.timeObject)(gregObj));
}
...
function weekToGregorian(weekData) {
  ...
  return Object.assign({ year, month, day }, (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.timeObject)(weekData));
}
...
function gregorianToOrdinal(gregData) {
  ...
  return Object.assign({ year, ordinal }, (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.timeObject)(gregData));
}
...
function ordinalToGregorian(ordinalData) {
  ...
  return Object.assign({ year, month, day }, (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.timeObject)(ordinalData));
}
...
function supportsFastNumbers(loc) {
  if (loc.numberingSystem && loc.numberingSystem !== "latn") {
    ...
    return (
      ...
      ((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.hasIntl)() && new Intl.DateTimeFormat(loc.intl).resolvedOptions().numberingSystem === "latn")
    );
  }
}
...
class PolyDateFormatter {
  ...
  format() {
    if (this.hasIntl) {
      ...
      const tokenFormat = _english_js__WEBPACK_IMPORTED_MODULE_3__.formatString(this.opts),
...
class Locale {
  ...
  static create(locale, numberingSystem, outputCalendar, defaultToEN = false) {
    const specifiedLocale = locale || _settings_js__WEBPACK_IMPORTED_MODULE_5__["default"].defaultLocale,
      // the system locale is useful for human readable strings but annoying for parsing/formatting known formats
      localeR = specifiedLocale || (defaultToEN ? "en-US" : systemLocale()),
      numberingSystemR = numberingSystem || _settings_js__WEBPACK_IMPORTED_MODULE_5__["default"].defaultNumberingSystem,
      outputCalendarR = outputCalendar || _settings_js__WEBPACK_IMPORTED_MODULE_5__["default"].defaultOutputCalendar;
  ...
  listingMode(defaultOK = true) {
    const intl = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.hasIntl)(),
      hasFTP = intl && (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.hasFormatToParts)(),
    ...
    return listStuff(
      ...
      () => {
        ...
        if (!this.meridiemCache) {
          ...
          this.meridiemCache = [_datetime_js__WEBPACK_IMPORTED_MODULE_1__["default"].utc(2016, 11, 13, 9), _datetime_js__WEBPACK_IMPORTED_MODULE_1__["default"].utc(2016, 11, 13, 19)].map(
  ...
  eras(length, defaultOK = true) {
    return listStuff(this, length, defaultOK, _english_js__WEBPACK_IMPORTED_MODULE_3__.eras, () => {
      ...
      if (!this.eraCache[length]) {
        this.eraCache[length] = [_datetime_js__WEBPACK_IMPORTED_MODULE_1__["default"].utc(-40, 1, 1), _datetime_js__WEBPACK_IMPORTED_MODULE_1__["default"].utc(2017, 1, 1)].map(dt =>
  ...
  isEnglish() {
    return (
      ...
      ((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.hasIntl)() && new Intl.DateTimeFormat(this.intl).resolvedOptions().locale.startsWith("en-us"))
    );
  }
  ...
  formatDateTimeFromString(dt, fmt) {
    const knownEnglish = this.loc.listingMode() === "en",
      useDateTimeFormatter =
        this.loc.outputCalendar && this.loc.outputCalendar !== "gregory" && (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.hasFormatToParts)(),
...
class Info {
  ...
  static hasDST(zone = _settings_js__WEBPACK_IMPORTED_MODULE_0__["default"].defaultZone) {
    const proto = _datetime_js__WEBPACK_IMPORTED_MODULE_1__["default"].now()
      .setZone(zone)
      .set({ month: 12 });
